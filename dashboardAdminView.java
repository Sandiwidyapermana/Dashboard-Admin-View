...
private cLabelInfo labelJmlTransaksiPulsaBeranda = new cLabelInfo("Jumlah Transaksi Telur Berhasil", 25, 280);
private cBigFont valueJmlTransaksiPulsaBeranda = new cBigFont("0", 25, 320);
private cLabelInfo labelJmlTransaksiPaketBeranda = new cLabelInfo("Jumlah Transaksi Vitamin Berhasil", 495, 20);
...
private cBigFont valueJmlRequestSaldoBeranda = new cBigFont("0", 495, 320);
  ...
  private cLabelInfo labelTransaksiPulsa = new cLabelInfo("Semua Data Transaksi Telur", 25, 20);
  ...
  private cLabelInfo labelTransaksiPaket = new cLabelInfo("Semua Data Transaksi Vitamin", 25, 20);
